...
public class ArraysGUI extends JFrame {
	...
	public ArraysGUI() {
		...
		this.repositorioCliente = new RepositorioClienteLista();
		...
		btnDescadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				JOptionPane.showMessageDialog(ArraysGUI.this, "Cliente removido com o cpf " + cpf + " tinha o nome: " + removido.getNome());
			}
		});
		...
		btnRecuperar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//TODO: recuperar
				String cpf = txtCPF.getText();
				Cliente recuperado = ArraysGUI.this.repositorioCliente.recuperarCliente(cpf);
				JOptionPane.showMessageDialog(ArraysGUI.this, "Cliente recuperado com o cpf " + cpf + " tem o nome: " + recuperado.getNome());
			}
		});
